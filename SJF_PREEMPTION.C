/////SJF Preemption Scheduling Algorithm ...............
   ///By , Subrata Mandal
...
void calculationCT(int at[], int bt[], int ct[], int size) 
 {
    int newCT = 0;
    int temp = size; // Remaining processes
    ...
    while (temp > 0) 
    {
        ...
        if (index == -1) 
        {
           newCT++;  // No process is ready, increment time  
        } 
        else 
        {
